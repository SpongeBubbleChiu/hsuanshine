...
/**
 * This class defines the structure of the 'site_config' table.
 *
 *
 *
...
class SiteConfigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Backend.BaseBundle.Model.map.SiteConfigTableMap';
    ...
    {
        // attributes
        $this->setName('site_config');
        $this->setPhpName('SiteConfig');
        $this->setClassname('Backend\\BaseBundle\\Model\\SiteConfig');
        $this->setPackage('src.Backend.BaseBundle.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('name', 'Name', 'VARCHAR', true, 128, null);
        $this->addColumn('config', 'Config', 'OBJECT', true, null, null);
