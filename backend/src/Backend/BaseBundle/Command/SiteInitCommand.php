...
use Backend\BaseBundle\Event\SiteInitEvent;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->dispatchEvent($input, $output);
    }
    ...
    protected function dispatchEvent(InputInterface $input, OutputInterface $output)
    {
        /** @var EventDispatcher $dispatcher */
        $dispatcher = $this->getContainer()->get("event_dispatcher");
        $dispatcher->dispatch(
            SiteInitEvent::EVENT_NAME,
            new SiteInitEvent($input, $output)
        );
    }
}
